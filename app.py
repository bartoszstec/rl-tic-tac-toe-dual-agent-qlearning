...
Q_ATTACK = None #load_model("q_table_A_best.pkl")      # loading Q_table to offensive strategy
Q_DEFENCE = None #load_model("q_table_D_best.pkl")     # loading Q_table to defensive strategy
